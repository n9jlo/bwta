...
**
** Created: Wed Jun 2 12:32:28 2010
...
static const uint qt_meta_data_QAbstractItemView[] = {
 ...
 // properties: name, type, flags
    ...
    1247, 1167, 0x01095003,
    1265, 1167, 0x01095103,
    1277, 1167, 0x01095103,
    1312, 1299, 0x0009510b,
    1340, 1325, 0x0009510b,
    1358, 1167, 0x01095103,
    1393, 1379, 0x0009510b,
    1425, 1407, 0x0009510b,
    1449, 1443, 0x15095103,
    1476, 1458, 0x0009510b,
    1501, 1490, 0x0009510b,
    1520, 1490, 0x0009510b,
 ...
 // enum data: key, value
    1552, uint(QAbstractItemView::NoSelection),
    1564, uint(QAbstractItemView::SingleSelection),
    1580, uint(QAbstractItemView::MultiSelection),
    1595, uint(QAbstractItemView::ExtendedSelection),
    1613, uint(QAbstractItemView::ContiguousSelection),
    1633, uint(QAbstractItemView::SelectItems),
    1645, uint(QAbstractItemView::SelectRows),
    1656, uint(QAbstractItemView::SelectColumns),
    1670, uint(QAbstractItemView::EnsureVisible),
    1684, uint(QAbstractItemView::PositionAtTop),
    1698, uint(QAbstractItemView::PositionAtBottom),
    1715, uint(QAbstractItemView::PositionAtCenter),
    1732, uint(QAbstractItemView::NoEditTriggers),
    1747, uint(QAbstractItemView::CurrentChanged),
    1762, uint(QAbstractItemView::DoubleClicked),
    1776, uint(QAbstractItemView::SelectedClicked),
    1792, uint(QAbstractItemView::EditKeyPressed),
    1807, uint(QAbstractItemView::AnyKeyPressed),
    1821, uint(QAbstractItemView::AllEditTriggers),
    1837, uint(QAbstractItemView::ScrollPerItem),
    1851, uint(QAbstractItemView::ScrollPerPixel),
    1866, uint(QAbstractItemView::NoDragDrop),
    1877, uint(QAbstractItemView::DragOnly),
    1886, uint(QAbstractItemView::DropOnly),
    1895, uint(QAbstractItemView::DragDrop),
    1904, uint(QAbstractItemView::InternalMove),
